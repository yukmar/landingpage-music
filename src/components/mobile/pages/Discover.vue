<template>
  <div class="mob-main">
    <div title="left" class="headline">
      ...
      <ul>
        ...
        <li>
          <svg width="56" height="54" viewBox="0 0 56 54" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              <clipPath id="clip0">
                <rect width="54.777" height="54" fill="white" transform="translate(0.618713)"/>
              </clipPath>
              <clipPath id="clip1">
                <rect width="54.777" height="54" fill="white" transform="translate(0.618713)"/>
              </clipPath>
      ...
      <p class="subtitle">By joining you can benefit by listening to the latest albums released.</p>
    </div>
    <div title="right">
      <img src="../../../assets/images/covers.jpg">
    </div>
  </div>
</template>
